function [hl1,hl2] = plotxx(ax, x1,y1,x2,y2,xlabels,ylabels)
...
%    set(ax,'Position',[0.12 0.12 0.75 0.70])
   ...
   set(get(ax,'xlabel'),'string',xlabels{1})
   set(get(ax2,'xlabel'),'string',xlabels{2})
   set(get(ax,'ylabel'),'string',ylabels{1})
