...
xPerforation = -396; % [m], source point
pumpingSchedule = [0 40; 0.05/35, 0.0]; % first row: start time, second row: pumping rate
rhoPerforation = 1000; % magma density in chamber
mu = 0.05; % [Pa*s]

filename = 'input/input_simID_3.mat';
