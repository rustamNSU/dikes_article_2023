...
pumpingSchedule = [0 10000; 4, 0.0]; % first row: start time, second row: pumping rate
rhoPerforation = 2500;
...
DissolvedGasPath = 'statePinatubo/pdpath0.4.mat';   % state data for dissolved gas

filename = 'input/input_simID_143001.mat';
